...
// minus swaps requested (1), force swaps (2), punishments (9).
// Suspension, admin /done, and punishment requests are excluded.
...
const translations = {
 ...
 // Usage messages
 'usage_addadmin': '❌ **Usage:** `/addadmin `\n\nExample: `/addadmin Dani`',
 'usage_removeadmin': '❌ **Usage:** `/removeadmin `\n\nExample: `/removeadmin Dani`',
 'usage_authorize': '❌ **Usage:** `/authorize `\n\nExample: `/authorize Eden`',
 ...
 'usage_removeuser': '❌ **Usage:** `/removeuser `\n\nExample: `/removeuser Dani`',
 ...
 'usage_removeuser': '❌ **שימוש:** `/removeuser `\n\nדוגמה: `/removeuser Dani`',
...
async function handleCommand(chatId, userId, userName, text) {
 ...
 let helpMessage = t(userId, 'help_title');
            ...
            helpMessage += t(userId, 'help_champion_title') + t(userId, 'help_champion_explanation');
